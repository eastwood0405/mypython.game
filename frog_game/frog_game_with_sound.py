...
pygame.mixer.music.load(os.path.join(music_path,"FroggerArcMainTrack.ogg.mp3"))
pygame.mixer.music.play(-1)

hop_sound = pygame.mixer.Sound(os.path.join(music_path,"sound-frogger-hop.wav"))

coin_sound = pygame.mixer.Sound(os.path.join(music_path,"sound-frogger-coin-in.wav"))

squash_sound = pygame.mixer.Sound(os.path.join(music_path,"sound-frogger-squash.wav"))

plunk_sound = pygame.mixer.Sound(os.path.join(music_path,"sound-frogger-plunk.wav"))
while running:
