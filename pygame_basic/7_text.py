...
# 배경 이미지 불러오기
background = pygame.image.load("C:\\Users\\dongrim\Desktop\\myPy\pygame_basic\\background.png")

#캐릭터 불러오기
character = pygame.image.load("C:\\Users\\dongrim\Desktop\\myPy\pygame_basic\\character.png")
...
#enemy
enemy = pygame.image.load("C:\\Users\\dongrim\Desktop\\myPy\pygame_basic\\enemy.png")
enemy_size=enemy.get_rect().size #이미지의 크기를 구해줌
enemy_width=enemy_size[0]#캐릭터의 가로 크기
enemy_height = enemy_size[1]#캐릭터의 세로 크기
enemy_x_pos = (screen_width/2)-(enemy_width/2)#화면 가로 절반 위치
enemy_y_pos = (screen_height/2)- (enemy_height/2)#화면 세로 크
